        ...
        <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <button onClick={onStartTrial}
                    className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition shadow-lg hover:shadow-xl flex items-center justify-center group">
                    Start Your $4.95 Trial
                    <ArrowRight className="ml-2 group-hover:translate-x-1 transition" size={20} />
                </button>
                <button
                  className="group relative bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-300 px-8 py-4 rounded-lg font-semibold text-lg transition flex items-center justify-center">
        ...
        <div className="mt-16 relative">
            ...
            */}
            <div className="rounded-xl flex items-center justify-center">
                ...
                <img src="./rental-equipment-software-dash-sales-trend.webp" alt="" />
            </div>
        </div>
    </div>
</section>
